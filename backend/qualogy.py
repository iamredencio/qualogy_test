...
def support_vector_machine(
    ...
    return clf  # cleanup_results(best_score, best_parameters, train_score, test_score, clf)
...
def get_recommendation(clf, profiles):
    ...
    empty_df = (
        get_dummies(data_proc.drop("AcomType", axis=1))
        .reset_index()
        .drop([x for x in range(len(data_proc))], axis=0)
    )
